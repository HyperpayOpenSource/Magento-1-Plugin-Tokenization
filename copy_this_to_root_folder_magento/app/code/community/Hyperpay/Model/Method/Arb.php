 ...
 *
 */
class Hyperpay_Model_Method_Arb extends Hyperpay_Model_Method_Abstract
{
     ...
     * @var string
     */
    protected $_code = 'hyperpay_arb';
    protected $_formBlockType = 'hyperpay/payment_form_arb';

    /**
     *
     * @var string
     */
    protected $_methodCode = 'arb';
    protected $_accountBrand = 'VISA MASTER';
